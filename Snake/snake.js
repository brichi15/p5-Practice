...
var extendLength = 3 // lenth of body extention after eat
...
function wrap()                         //warp
{
  if(sn.bod[0].x > wh-1) sn.bod[0].x = 0;
  else if(sn.bod[0].x < 0) sn.bod[0].x = wh-1;
  else if(sn.bod[0].y > ht-1) sn.bod[0].y = 0;
  else if(sn.bod[0].y < 0) sn.bod[0].y = ht-1;
}
